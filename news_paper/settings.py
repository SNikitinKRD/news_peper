...
LOGGING = {
    ...
    'formatters': {
        ...
        'time_level_path_message': {
            'format': '%(asctime)s %(levelname)s: file %(pathname)s; Message: %(message)s'
        },
        'time_level_path_message_trace': {
            'format': '%(asctime)s %(levelname)s: file %(pathname)s; Message: %(message)s ### Trace: %(exc_info)s'
        },
        'time_level_module_message': {
    ...
    'handlers': {
        ...
        'console_error_critical': {
            'level': 'ERROR',
            'class': 'logging.StreamHandler',
            'formatter': 'time_level_path_message_trace',
        },
        'general_file': {
            ...
            'formatter': 'time_level_module_message',
        },
        'errors_file': {
            'class': "logging.FileHandler",
            'filename': "errors.log",
    ...
    'loggers': {
        'my_log': {
            'handlers': ['console_debug', 'console_warning', 'general_file', 'console_error_critical'],
            'level': 'DEBUG',
            'propagate': True,
        },
        'django.request': {
